            ...
            <main className="container mx-auto p-2 md:p-4 lg:p-8">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
                    <div className="lg:col-span-2">
                        ...
                        {/* CORREÇÃO: Adicionada a verificação '&& comanda' para garantir que a prop não seja nula */}
                        {isAuthenticated && comanda && currentStep === 1 && !orderSubmitted && (
                            <StepWelcome config={appConfig} comanda={comanda} onNext={() => setStep(2)} />
                        )}
